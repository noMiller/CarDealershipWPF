...
namespace WpfApp4.AppData
{
    ...
    public partial class AudiStoreEntities : DbContext
    {
        public AudiStoreEntities()
            : base("name=AudiStoreEntities")
        {
        }
        ...
        public virtual DbSet<SellersTable> SellersTable { get; set; }
        public virtual DbSet<sysdiagrams> sysdiagrams { get; set; }
        public virtual DbSet<UsersTable> UsersTable { get; set; }
        public virtual DbSet<MechaniсTable> MechaniсTable { get; set; }
        public virtual DbSet<RepairTable> RepairTable { get; set; }
        public virtual DbSet<StatusTable> StatusTable { get; set; }
        public virtual DbSet<TypeCarsTable> TypeCarsTable { get; set; }
